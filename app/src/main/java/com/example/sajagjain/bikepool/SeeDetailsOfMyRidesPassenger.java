...
public class SeeDetailsOfMyRidesPassenger extends AppCompatActivity implements OnMapReadyCallback {
    ...
    TextView requestDestinationAddress,openPaymentWindow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_details_of_my_rides_passenger);

        Bundle bundle = getIntent().getExtras();


        final AcceptedRequestModel acceptedRequest = (AcceptedRequestModel) bundle.getSerializable("request");
        final UserModel model = (UserModel) bundle.getSerializable("user");

        final RequestModel request = acceptedRequest.getModel();
        ...
        startRide.setText("Status Pending");
...
//                DatabaseReference dR = FirebaseDatabase.getInstance().getReference("acceptedrequests").child(acceptedRequest.getAcceptedRequestModelUid());
//
//                //updating artist
//                AcceptedRequestModel acceptedRequestModel = new AcceptedRequestModel(request, acceptedRequest.getDriversUserId()
//                        , acceptedRequest.getPassengersUserId(), true, false,acceptedRequest.getAcceptedRequestModelUid());
//
//                dR.setValue(acceptedRequestModel);
//                Toast.makeText(SeeDetailsOfMyRidesPassenger.this, "Status Pending", Toast.LENGTH_LONG).show();
//                startRide.setText("Status Pending");
//                startRide.setEnabled(false);
//
//            }
//        });
        ...
        openPaymentWindow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SeeDetailsOfMyRidesPassenger.this,RideEnded.class)
                        .putExtra("cost",requestDriversCost.getText().toString())
                        .putExtra("driverphonenumber",model.getMobilenumber()));
            }
        });
