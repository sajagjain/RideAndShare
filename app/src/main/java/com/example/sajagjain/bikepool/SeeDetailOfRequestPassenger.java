...
public class SeeDetailOfRequestPassenger extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_detail_of_request_passenger);
        ...
        acceptRide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AcceptedRequestModel acceptedRequest=new AcceptedRequestModel(request,FirebaseAuth.getInstance().getUid(),request.getCreatedByUserId(),false,false,key);
                mDatabase.child(key).setValue(acceptedRequest);
                Toast.makeText(SeeDetailOfRequestPassenger.this,"Request Accepted",Toast.LENGTH_LONG).show();
                acceptRide.setText("Already Accepted");
                acceptRide.setEnabled(false);
            }
        });
