...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.RequestViewHolder> {
    ...
    public RequestAdapter(List<RequestModel> requests, int rowLayout, Context context,RequestAdapterListener listener) {
    ...
    @Override
    public RequestAdapter.RequestViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
    ...
    public void onBindViewHolder(RequestViewHolder holder, final int position) {
        ...
        holder.requestSource.setText(requests.get(position).getSourceName());
        holder.requestDestination.setText(requests.get(position).getDestinationName());
        holder.requestDated.setText(requests.get(position).getTravelDate().toString());
        holder.requestSourceAddress.setText(requests.get(position).getSourceAddress());
        holder.requestDestinationAddress.setText(requests.get(position).getDestinationAddress());
